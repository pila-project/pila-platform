<template>
  <div class="split-panes">
    <div class="pane">
      <div class="wrapper">
        <h3 style="color: var(--color-primary-600);">{{ GET_TEXT.MAIN_HEADER }}</h3>
        ...
        <div class="class-list">
          <div style="display: flex; justify-content: space-between; align-items: flex-top; margin-bottom: 12px;">
            <h3 style="color: var(--color-primary-600);">{{ GET_TEXT.LIST_HEADER }}</h3>
        ...
        <br>
        <div style="display: flex; justify-content: space-between;">
          <h3 style="color: var(--color-primary-600);"> {{ GET_TEXT.MEMBER_LIST_HEADER }}</h3>
          <div>
            <PButton
              icon="print"
              variant="primary"
    ...
    <div class="pane" v-if="current" :key="current">
      <div style="padding: 8px;">
        <div>
          <h3 style="display: inline-block; margin-right: 17px; color: var(--color-primary-600);">
        ...
        <h4 style="color: var(--color-primary-600);">{{ GET_TEXT.TABLE_HEADER }}</h4>
        <table class="w-full border-collapse">
          <thead>
            <tr class="bg-slate-50 border-b border-slate-200">
              <th class="table-header-cell">{{ GET_TEXT.MEMBER_COL_HEADER }}</th>
            </tr>
          </thead>
          <tbody>
            <tr
              ...
              class="table-row"
            >
              <td class="table-cell" style="text-align: left;"><DecryptedName :user="member" /></td>
            </tr>
            <tr
              ...
              class="table-row"
            >
              <td class="table-cell" style="width: 250px;">-</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    >
      ...
      <template v-slot:body>
        <div style="padding: 20px 42px; text-align: center;">
          ...
          <br>
          <input v-model="namePassword" class="input mt-4" style="width: 60%; text-align: center;" />
        </div>
      </template>
    </PModal>
    <PModal
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      closeNamePasswordModal() {
        this.showNamePasswordModal = false
      },
      async add() {
        const { type } = this
