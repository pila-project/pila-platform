	...
	<div class="create-edit-group-modal">
		...
		<div class="filters">
			...
			<PButton class="filter-button"
				...
				:text="t('members')"
				:variant="filter === 'members' ? 'primary' : 'outline'"
			/>
			<PButton class="filter-button"
				@click="filter = 'non-members'"
				:text="t('non-members')"
				:variant="filter === 'non-members' ? 'primary' : 'outline'"
			/>
		</div>

		<div class="add-remove-all-buttons-wrapper">
			<PButton class="add-all-button"
				@click="addAll"
				:text="t('add-all')"
				icon="plus-circle"
				variant="primary"
			/>
			<PButton class="remove-all-button"
				@click="removeAll"
				:text="t('remove-all')"
				icon="minus-circle"
				variant="danger"
