export default {
  ...
  "create-unique-encryption-code": {
    "de": "Geben Sie Ihren eindeutigen Verschlüsselungscode ein",
    "en": "Enter your unique encryption code",
    "es": "Introduce tu código de cifrado único",
    "fr": "Saisissez votre code de chiffrement unique",
    "km": "បញ្ចូលលេខកូដអ៊ីនគ្រីបពិសេសរបស់អ្នក",
    "lv": "Ievadiet savu unikālo šifrēšanas kodu",
    "nl": "Voer je unieke versleutelingscode in",
  ...
  "encryption-code-intro": {
    ...
    "en": "Enter your unique encryption code (like a password) below, or create one if you are a first time user. This code protects your students’ information and lets you access it securely.",
    "es": "Introduce abajo tu código de cifrado único (como una contraseña), o crea uno si eres un usuario nuevo. Este código protege la información de tus estudiantes y te permite acceder a ella de forma segura.",
    "fr": "Saisissez ci-dessous votre code de chiffrement unique (comme un mot de passe), ou créez-en un si vous êtes un nouvel utilisateur. Ce code protège les informations de vos élèves et vous permet d’y accéder en toute sécurité.",
    "km": "បញ្ចូលលេខកូដអ៊ីនគ្រីបពិសេស (ដូចពាក្យសម្ងាត់) ខាងក្រោម ឬបង្កើតមួយប្រសិនបើអ្នកជាអ្នកប្រើលើកដំបូង។ លេខកូដនេះការពារព័ត៌មានសិស្សរបស់អ្នក និងអនុញ្ញាតឱ្យអ្នកចូលប្រើដោយសុវត្ថិភាព។",
    "lv": "Tālāk ievadiet savu unikālo šifrēšanas kodu (piemēram, paroli) vai izveidojiet jaunu, ja esat pirmreizējs lietotājs. Šis kods aizsargā jūsu skolēnu informāciju un ļauj tai droši piekļūt.",
    "nl": "Voer hieronder je unieke versleutelingscode (zoals een wachtwoord) in, of maak er een aan als je een nieuwe gebruiker bent. Deze code beschermt de gegevens van je leerlingen en geeft je er veilig toegang toe.",
  ...
  "encryption-code-keep-safe": {
    ...
    "en": "You’ll be asked to input this code again when you switch devices, browsers, or clear your browsing data.",
    "es": "Tendrás que introducir este código de nuevo cuando cambies de dispositivo o de navegador, o borres los datos de navegación.",
    "fr": "Vous devrez saisir ce code à nouveau lorsque vous changerez d’appareil ou de navigateur, ou effacerez vos données de navigation.",
    "km": "អ្នកនឹងត្រូវបញ្ចូលលេខកូដនេះម្តងទៀត នៅពេលអ្នកប្តូរឧបករណ៍ កម្មវិធីរុករក ឬលុបទិន្នន័យរុករក។",
    "lv": "Jums būs jāievada šis kods atkārtoti, kad mainīsiet ierīci vai pārlūku vai notīrīsiet pārlūka datus.",
    "nl": "Je wordt gevraagd deze code opnieuw in te voeren wanneer je van apparaat of browser wisselt of je browsegegevens wist.",
