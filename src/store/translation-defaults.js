...
export default {
  ...
  'add-content-to-sequence': 'Add to sequence',
  'add-feedback': 'Add Feedback',
  'add-picker-subtitle': 'Choose where to add the selected content',
  ...
  'add-to-existing-sequence': 'Add to an existing sequence',
  'add-to-existing-sequence-subtitle': 'Choose a sequence you want to add {name} to.',
  'add-to-existing-sequence-title': 'Add to an existing sequence',
  'add-to-favorites': 'Add to favorites',
  'add-to-groups': 'Add To Groups',
  'add-to-selected-assignment': 'Add to the selected assignment',
  'add-to-sequence-choice-subtitle': 'Choose how you want to add {name} to a sequence.',
  ...
  'cannot-add-sequences-to-sequence': 'Sequences cannot be added inside another sequence. Select content items instead.',
  'create-new-sequence': 'Create a new sequence',
  'one-item-added-to-sequence': '1 item added to sequence',
  'n-items-added-to-sequence': '{count} items added to sequence',
  'sequence-created-successfully': 'Sequence created successfully',
  ...
  /** UIUX-49 soft: same name, different grade — still created */
  'bulk-duplicate-soft-grade-note':
    '{count} row(s) share a name with an existing student at a different grade and will still be created:',
  'duplicate-soft-existing-grade': 'existing grade {grade}',
  'duplicate-student-different-grade':
    'A student account named "{name}" already exists at a different grade level ({grade}). Do you want to create this new account?',
  'cancel': 'cancel',
  'close': 'Close',
